...
//Cuentas bancarias
export const get_cuentas = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
    ...
    if (req.user.isAdmin || req.user.empresas.includes(+cuenta.empresa_id)) {
      res.status(200).json({
        ...
        updatable: Object.keys(
          zodToJsonSchema(updateCuentaSchema)["properties"]["body"][
            "properties"
          ]
        ),
      });
...
export const get_cuentas_by_empresa = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const create_cuenta = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const get_cuenta_schema = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  return res.status(200).json(Object.keys(
    zodToJsonSchema(createCuentaSchema)["properties"][
      "body"
    ]["properties"]
  ));
};

export const update_cuenta = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const delete_cuenta = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const get_movimiento = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    res.status(200).json({
      data: movimiento,
      updatable: Object.keys(
        zodToJsonSchema(updateMovimientoSchema)["properties"]["body"][
          "properties"
        ]
      ),
    });
...
export const get_movimientos_by_cuenta = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const get_movimiento_schema = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  return res
    ...
    .json(
      Object.keys(
        zodToJsonSchema(createMovimientoSchema)["properties"][
          "body"
        ]["properties"]
      )
    );
...
export const update_movimiento = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  try {
    ...
    if (cuenta_id) {
      ...
      if (
        !req.user.isAdmin &&
        !req.user.empresas.includes(+cuenta.empresa_id)
      ) {
        return next(createError("Unauthorized", 401));
      }
    }
...
export const delete_movimiento = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
