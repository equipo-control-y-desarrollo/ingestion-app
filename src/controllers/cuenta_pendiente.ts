...
export const get_cuentas_pendientes = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const get_cuenta_pendiente = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  try {
    ...
    if (
      req.user.isAdmin ||
      req.user.empresas.includes(+cuenta_pendiente.empresa_id)
    ) {
      return res.status(200).json({
        data: cuenta_pendiente,
        updatable: Object.keys(
          zodToJsonSchema(updateCuentaPendienteSchema)["properties"]["body"][
            "properties"
          ]
        ),
      });
...
export const get_cuentas_pendientes_by_empresa = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const create_cuenta_pendiente = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const get_cuenta_pendiente_schema = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
...
export const update_cuenta_pendiente = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
  ...
  try {
    ...
    const new_fecha_recibido = fecha_recibido
      ? new Date(fecha_recibido)
      : undefined;
    const new_fecha_vencida = fecha_vencida
      ? new Date(fecha_vencida)
      : undefined;
...
export const delete_cuenta_pendiente = async (
  req: Request,
  res: Response,
  next: NextFunction
) => {
